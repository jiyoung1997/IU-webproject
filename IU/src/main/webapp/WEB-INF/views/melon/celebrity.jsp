...
<body>
	...
	<div class="bg-image"
        style="background: url(melonimage/celecover.jpg) repeat no-repeat center;  background-size: cover;  ">
        ...
        <div class="album-cover">
            ...
            <img src="melonimage/celecover.jpg" alt="celebrity" class="album-img">
            <div class="song-info">
