...
<body>
	...
	<div class="bg-image"
        style="background: url(melonimage/에잇.jpg) repeat no-repeat center;  background-size: cover;  ">
        ...
        <div class="album-cover">
            ...
            <img src="melonimage/에잇.jpg" alt="celebrity" class="album-img">
            <div class="song-info">
    ...
    <!-- The Modal -->
    <div id="myModal" class="modal" style="background-color: rgb(157, 93, 111,0.95);">
        ...
        <div class="modal-content">
            ...
            <div class="mv">
                ...
                <iframe width="700" height="600" src="https://www.youtube.com/embed/TgOu00Mf3kI"
